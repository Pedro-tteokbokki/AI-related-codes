from Pedro_package import Pedro_Layer
import Pedro_package.layers as L
import Pedro_package.functions as F
from Pedro_package import utils
import numpy as np
...
# =============================================================================
class Pedro_Model(Pedro_Layer):
    def plot(self, *inputs, verbose=True, to_file='model.png'):
        y = self.forward(*inputs)
        return utils.plot_dot_graph(y, verbose=verbose, to_file=to_file)


class Pedro_TwoLayerNet(Pedro_Model):
    def __init__(self, hidden_size, out_size):
        super().__init__()
        self.l1 = L.Pedro_Linear(hidden_size)
        self.l2 = L.Pedro_Linear(out_size)
