...
class Pedro_Layer:
    ...
    def __setattr__(self, name, value):
        if isinstance(value, (Pedro_Parameter, Pedro_Layer)):
...
# =============================================================================
class Pedro_Linear_Old(Pedro_Layer):
    def __init__(self, in_size, out_size, nobias=False, dtype=np.float32):
        super().__init__()
        
        I, O = in_size, out_size
        W_data = np.random.randn(I, O).astype(dtype) * np.sqrt(1 / I)
        self.W = Pedro_Parameter(W_data, name='W')
        if nobias:
            self.b = None
        else:
            self.b = Pedro_Parameter(np.zeros(O, dtype=dtype), name='b')
...
class Pedro_Linear(Pedro_Layer):
    def __init__(self, out_size, nobias=False, dtype=np.float32, in_size=None):
        ...
        self.W = Pedro_Parameter(None, name='W')
        ...
        if nobias:
            ...
            self.b = Pedro_Parameter(np.zeros(out_size, dtype=dtype), name='b')
...
class Pedro_TwoLayerNet_Temp(Pedro_Layer):
    def __init__(self, hidden_size, out_size):
        super().__init__()
        self.l1 = Pedro_Linear(hidden_size)
        self.l2 = Pedro_Linear(out_size)
...
class Conv2d(Pedro_Layer):
    def __init__(self, out_channels, kernel_size, stride=1,
        ...
        if nobias:
            ...
            self.b = Pedro_Parameter(np.zeros(out_channels, dtype=dtype), name='b')
...
# EmbedID / BatchNorm
# =============================================================================
class EmbedID(Pedro_Layer):
    def __init__(self, in_size, out_size):
        super().__init__()
        self.W = Pedro_Parameter(np.random.randn(in_size, out_size), name='W')
...
class BatchNorm(Pedro_Layer):
    def __init__(self):
        ...
        self.avg_mean = Pedro_Parameter(None, name='avg_mean')
        self.avg_var = Pedro_Parameter(None, name='avg_var')
        self.gamma = Pedro_Parameter(None, name='gamma')
        self.beta = Pedro_Parameter(None, name='beta')
